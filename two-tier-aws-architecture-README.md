...
4. Built a Route Table directing `0.0.0.0/0` traffic to the Internet Gateway, and associated it *only* with the public subnet — private subnets were deliberately left off this table
